  ...
  return {
    ...
    execute: function () {
      ...
      */
      !function (t, e, i) {
        var n = t.L,
            o = {};o.version = "0.7.7", "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && "object" == _typeof(module.exports) ? module.exports = o : "function" == typeof define && define.amd && define(o), o.noConflict = function () {
          return t.L = n, this;
      ...
      */
      !function (t, e, i) {
        L.MarkerClusterGroup = L.FeatureGroup.extend({ options: { maxClusterRadius: 80, iconCreateFunction: null, spiderfyOnMaxZoom: !0, showCoverageOnHover: !0, zoomToBoundsOnClick: !0, singleMarkerMode: !1, disableClusteringAtZoom: null, removeOutsideVisibleBounds: !0, animate: !0, animateAddingMarkers: !1, spiderfyDistanceMultiplier: 2, spiderLegPolylineOptions: { weight: 1.5, color: "#222", opacity: .5 }, chunkedLoading: !1, chunkInterval: 200, chunkDelay: 50, chunkProgress: null, polygonOptions: {} }, initialize: function initialize(t) {
            L.Util.setOptions(this, t), this.options.iconCreateFunction || (this.options.iconCreateFunction = this._defaultIconCreateFunction), this._featureGroup = L.featureGroup(), this._featureGroup.on(L.FeatureGroup.EVENTS, this._propagateEvent, this), this._nonPointGroup = L.featureGroup(), this._nonPointGroup.on(L.FeatureGroup.EVENTS, this._propagateEvent, this), this._inZoomAnimation = 0, this._needsClustering = [], this._needsRemoving = [], this._currentShownBounds = null, this._queue = [];var e = L.DomUtil.TRANSITION && this.options.animate;L.extend(this, e ? this._withAnimation : this._noAnimation), this._markerCluster = e ? L.MarkerCluster : L.MarkerClusterNonAnimated;
          }, addLayer: function addLayer(t) {
            if (t instanceof L.LayerGroup) {
              var e = [];for (var i in t._layers) {
                e.push(t._layers[i]);
              }return this.addLayers(e);
            }if (!t.getLatLng) return this._nonPointGroup.addLayer(t), this;if (!this._map) return this._needsClustering.push(t), this;if (this.hasLayer(t)) return this;this._unspiderfy && this._unspiderfy(), this._addLayer(t, this._maxZoom), this._topClusterLevel._recalculateBounds();var n = t,
            ...
            var e,
              ...
              var _ = 0,
                ...
                for (var e = new Date().getTime(); _ < t.length; _++) {
                  if (a && 0 === _ % 200) {
                    var i = new Date().getTime() - e;if (i > h) break;
                ...
                }u && u(_, t.length, new Date().getTime() - l), _ === t.length ? (this._topClusterLevel._recalculateBounds(), this._featureGroup.eachLayer(function (t) {
            ...
            var e,
              ...
              for (e = 0, i = t.length; i > e; e++) {
                n = t[e], this._arraySplice(this._needsClustering, n), r.removeLayer(n), this.hasLayer(n) && this._needsRemoving.push(n);
              }return this;
            }if (this._unspiderfy) for (this._unspiderfy(), e = 0, i = t.length; i > e; e++) {
              n = t[e], this._unspiderfyLayer(n);
            }for (e = 0, i = t.length; i > e; e++) {
              n = t[e], n.__parent ? (this._removeLayer(n, !0, !0), s.hasLayer(n) && (s.removeLayer(n), n.clusterShow && n.clusterShow())) : r.removeLayer(n);
            }return this._topClusterLevel._recalculateBounds(), this._topClusterLevel._recursivelyAddChildrenToMap(null, this._zoom, this._currentShownBounds), s.eachLayer(function (t) {
            ...
            var t = new L.LatLngBounds();this._topClusterLevel && t.extend(this._topClusterLevel._bounds);for (var e = this._needsClustering.length - 1; e >= 0; e--) {
            ...
            var e = null;return t = parseInt(t, 10), this.eachLayer(function (i) {
              L.stamp(i) === t && (e = i);
            }), e;
          }, hasLayer: function hasLayer(t) {
            if (!t) return !1;var e,
            ...
            "function" != typeof e && (e = function e() {});var i = function i() {
            ...
            this._map = t;var e, i, n;if (!isFinite(this._map.getMaxZoom())) throw "Map has no maxZoom specified";for (this._featureGroup.onAdd(t), this._nonPointGroup.onAdd(t), this._gridClusters || this._generateInitialClusters(), this._maxLat = t.options.crs.projection.MAX_LATITUDE, e = 0, i = this._needsRemoving.length; i > e; e++) {
            ...
            t.off("zoomend", this._zoomEnd, this), t.off("moveend", this._moveEnd, this), this._unbindEvents(), this._map._mapPane.className = this._map._mapPane.className.replace(" leaflet-cluster-anim", ""), this._spiderfierOnRemove && this._spiderfierOnRemove(), delete this._maxLat, this._hideCoverage(), this._featureGroup.onRemove(t), this._nonPointGroup.onRemove(t), this._featureGroup.clearLayers(), this._map = null;
          ...
          }, _removeFromGridUnclustered: function _removeFromGridUnclustered(t, e) {
            for (var i = this._map, n = this._gridUnclustered; e >= 0 && n[e].removeObject(t, i.project(t.getLatLng(), e)); e--) {}
          }, _removeLayer: function _removeLayer(t, e, i) {
            var n = this._gridClusters,
                s = this._gridUnclustered,
                r = this._featureGroup,
                o = this._map;e && this._removeFromGridUnclustered(t, this._maxZoom);var a,
                h = t.__parent,
                u = h._markers;for (this._arraySplice(u, t); h && (h._childCount--, h._boundsNeedUpdate = !0, !(h._zoom < 0));) {
              e && h._childCount <= 1 ? (a = h._markers[0] === t ? h._markers[1] : h._markers[0], n[h._zoom].removeObject(h, o.project(h._cLatLng, h._zoom)), s[h._zoom].addObject(a, o.project(a.getLatLng(), h._zoom)), this._arraySplice(h.__parent._childClusters, h), h.__parent._markers.push(a), a.__parent = h.__parent, h._icon && (r.removeLayer(h), i || r.addLayer(a))) : i && h._icon || h._updateIcon(), h = h.__parent;
            }delete t.__parent;
            ...
            var t = this._map.getMaxZoom(),
                ...
                i = e;"function" != typeof e && (i = function i() {
              return e;
            }), this.options.disableClusteringAtZoom && (t = this.options.disableClusteringAtZoom - 1), this._maxZoom = t, this._gridClusters = {}, this._gridUnclustered = {};for (var n = t; n >= 0; n--) {
            ...
            var i,
                ...
                r = this._gridUnclustered;for (this.options.singleMarkerMode && this._overrideMarkerIcon(t); e >= 0; e--) {
              i = this._map.project(t.getLatLng(), e);var o = s[e].getNearObject(i);if (o) return o._addChild(t), t.__parent = o, void 0;if (o = r[e].getNearObject(i)) {
                var a = o.__parent;a && this._removeLayer(o, !1);var h = new this._markerCluster(this, e, o, t);s[e].addObject(h, this._map.project(h._cLatLng, e)), o.__parent = h, t.__parent = h;var u = h;for (n = e - 1; n > a._zoom; n--) {
                  u = new this._markerCluster(this, n, u), s[n].addObject(u, this._map.project(o.getLatLng(), n));
                }return a._addChild(u), this._removeFromGridUnclustered(o, e), void 0;
              }r[e].addObject(t, i);
          ...
          }, _checkBoundsMaxLat: function _checkBoundsMaxLat(t) {
            var e = this._maxLat;return e !== i && (t.getNorth() >= e && (t._northEast.lat = 1 / 0), t.getSouth() <= -e && (t._southWest.lat = -1 / 0)), t;
          ...
          }, _overrideMarkerIcon: function _overrideMarkerIcon(t) {
            var e = t.options.icon = this.options.iconCreateFunction({ getChildCount: function getChildCount() {
                return 1;
              }, getAllChildMarkers: function getAllChildMarkers() {
                return [t];
              } });return e;
          } }), L.MarkerClusterGroup.include({ _mapBoundsInfinite: new L.LatLngBounds(new L.LatLng(-1 / 0, -1 / 0), new L.LatLng(1 / 0, 1 / 0)) }), L.MarkerClusterGroup.include({ _noAnimation: { _animationStart: function _animationStart() {}, _animationZoomIn: function _animationZoomIn(t, e) {
              ...
              var i,
                ...
                var o,
                    a = r._latlng,
                    h = r._markers;for (n.contains(a) || (a = null), r._isSingleParent() && t + 1 === e ? (s.removeLayer(r), r._recursivelyAddChildrenToMap(null, e, n)) : (r.clusterHide(), r._recursivelyAddChildrenToMap(a, e, n)), i = h.length - 1; i >= 0; i--) {
              ...
              var i = this,
                  n = this._featureGroup;n.addLayer(t), e !== t && (e._childCount > 2 ? (e._updateIcon(), this._forceLayout(), this._animationStart(), t._setPos(this._map.latLngToLayerPoint(e.getLatLng())), t.clusterHide(), this._enqueue(function () {
            ...
            var n = this._getExpandedVisibleBounds();t._recursivelyAnimateChildrenInAndAddSelfToMap(n, e + 1, i);var s = this;this._forceLayout(), t._recursivelyBecomeVisible(n, i), this._enqueue(function () {
              if (1 === t._childCount) {
                var r = t._markers[0];r.setLatLng(r.getLatLng()), r.clusterShow && r.clusterShow();
          ...
          return new L.MarkerClusterGroup(t);
            ...
            L.Marker.prototype.initialize.call(this, i ? i._cLatLng || i.getLatLng() : new L.LatLng(0, 0), { icon: this }), this._group = t, this._zoom = e, this._markers = [], this._childClusters = [], this._childCount = 0, this._iconNeedsUpdate = !0, this._boundsNeedUpdate = !0, this._bounds = new L.LatLngBounds(), i && this._addChild(i), n && this._addChild(n);
          ...
          }, _setClusterCenter: function _setClusterCenter(t) {
            this._cLatLng || (this._cLatLng = t._cLatLng || t._latlng);
          }, _resetBounds: function _resetBounds() {
            var t = this._bounds;t._southWest && (t._southWest.lat = 1 / 0, t._southWest.lng = 1 / 0), t._northEast && (t._northEast.lat = -1 / 0, t._northEast.lng = -1 / 0);
            ...
            var t,
              ...
              for (this._resetBounds(), t = 0; t < s.length; t++) {
                i = s[t]._latlng, this._bounds.extend(i), o += i.lat, a += i.lng;
              }for (t = 0; t < r.length; t++) {
                e = r[t], e._boundsNeedUpdate && e._recalculateBounds(), this._bounds.extend(e._bounds), i = e._wLatLng, n = e._childCount, o += i.lat * n, a += i.lng * n;
            ...
            this._recursively(t, 0, i - 1, function (t) {
              var i,
                ...
                n = s[i], n._icon && (n._setPos(e), n.clusterHide());
              }
            }, function (t) {
              var i,
                  n,
            ...
            this._recursively(t, i, 0, function (n) {
              n._recursivelyAnimateChildrenIn(t, n._group._map.latLngToLayerPoint(n.getLatLng()).round(), e), n._isSingleParent() && e - 1 === i ? (n.clusterShow(), n._recursivelyRemoveChildrenFromMap(t, e)) : n.clusterHide(), n._addToMap();
            });
            ...
            this._recursively(i, -1, e, function (n) {
              if (e !== n._zoom) for (var s = n._markers.length - 1; s >= 0; s--) {
                var r = n._markers[s];i.contains(r._latlng) && (t && (r._backupLatlng = r.getLatLng(), r.setLatLng(t), r.clusterHide && r.clusterHide()), n._group._featureGroup.addLayer(r));
              }
            }, function (e) {
              e._addToMap(t);
            });
            ...
            var n, s;this._recursively(t, -1, e - 1, function (t) {
              for (s = t._markers.length - 1; s >= 0; s--) {
                n = t._markers[s], i && i.contains(n._latlng) || (t._group._featureGroup.removeLayer(n), n.clusterShow && n.clusterShow());
              }
            }, function (t) {
              for (s = t._childClusters.length - 1; s >= 0; s--) {
                n = t._childClusters[s], i && i.contains(n._latlng) || (t._group._featureGroup.removeLayer(n), n.clusterShow && n.clusterShow());
              }
            });
            ...
            var t = this.setOpacity(this.options.opacity || this.options.opacityWhenUnclustered);return delete this.options.opacityWhenUnclustered, t;
          ...
          this._cellSize = t, this._sqCellSize = t * t, this._grid = {}, this._objectPoint = {};
            ...
            var e,
                ...
                l = this._objectPoint,
                d = this._sqCellSize,
                c = null;for (e = _ - 1; _ + 1 >= e; e++) {
              if (s = this._grid[e]) for (i = u - 1; u + 1 >= i; i++) {
                if (r = s[i]) for (n = 0, o = r.length; o > n; n++) {
                  a = r[n], h = this._sqDist(l[L.Util.stamp(a)], t), d > h && (d = h, c = a);
                }
              }
            }return c;
          ...
          L.QuickHull = { getDistant: function getDistant(t, e) {
              ...
              var e,
                  ...
                  u = null,
                  _ = null,
                  l = null;for (e = t.length - 1; e >= 0; e--) {
                var d = t[e];(i === !1 || d.lat > i) && (o = d, i = d.lat), (n === !1 || d.lat < n) && (a = d, n = d.lat), (s === !1 || d.lng > s) && (h = d, s = d.lng), (r === !1 || d.lng < r) && (u = d, r = d.lng);
              }n !== i ? (l = a, _ = o) : (l = u, _ = h);var c = [].concat(this.buildConvexHull([l, _], t), this.buildConvexHull([_, l], t));return c;
            } };
            ...
            var i,
                ...
                a = 0,
                h = [];for (h.length = t, i = t - 1; i >= 0; i--) {
              a += r / s + 5e-4 * i, h[i] = new L.Point(e.x + s * Math.cos(a), e.y + s * Math.sin(a))._round(), s += o / a;
            }return h;
            ...
            }i.fire("unspiderfied", { cluster: this, markers: r }), i._spiderfied = null;
          } }), L.MarkerClusterNonAnimated = L.MarkerCluster.extend({ _animationSpiderfy: function _animationSpiderfy(t, e) {
            var i,
                n,
                s,
                r,
                ...
                a = o._map,
                h = o._featureGroup,
                u = this._group.options.spiderLegPolylineOptions;for (i = 0; i < t.length; i++) {
              r = a.layerPointToLatLng(e[i]), n = t[i], s = new L.Polyline([this._latlng, r], u), a.addLayer(s), n._spiderLeg = s, n._preSpiderfyLatlng = n._latlng, n.setLatLng(r), n.setZIndexOffset && n.setZIndexOffset(1e6), h.addLayer(n);
            }this.setOpacity(.3), o.fire("spiderfied", { cluster: this, markers: t });
          }, _animationUnspiderfy: function _animationUnspiderfy() {
            this._noanimationUnspiderfy();
          } }), L.MarkerCluster.include({ _animationSpiderfy: function _animationSpiderfy(t, e) {
            var n,
                s,
                r,
                o,
                ...
                g = m.opacity;for (g === i && (g = L.MarkerClusterGroup.prototype.options.spiderLegPolylineOptions.opacity), f ? (m.opacity = 0, m.className = (m.className || "") + " leaflet-cluster-spider-leg") : m.opacity = g, n = 0; n < t.length; n++) {
              s = t[n], h = l.layerPointToLatLng(e[n]), r = new L.Polyline([c, h], m), l.addLayer(r), s._spiderLeg = r, f && (o = r._path, a = o.getTotalLength() + .1, o.style.strokeDasharray = a, o.style.strokeDashoffset = a), s.setZIndexOffset && s.setZIndexOffset(1e6), s.clusterHide && s.clusterHide(), d.addLayer(s), s._setPos && s._setPos(p);
            }for (_._forceLayout(), _._animationStart(), n = t.length - 1; n >= 0; n--) {
              h = l.layerPointToLatLng(e[n]), s = t[n], s._preSpiderfyLatlng = s._latlng, s.setLatLng(h), s.clusterShow && s.clusterShow(), f && (r = s._spiderLeg, o = r._path, o.style.strokeDashoffset = 0, r.setStyle({ opacity: g }));
            }this.setOpacity(.3), setTimeout(function () {
              _._animationEnd(), _.fire("spiderfied", { cluster: u, markers: t });
            }, 200);
            ...
            var e,
                ...
                u = h._map,
                _ = h._featureGroup,
                l = t ? u._latLngToNewLayerPoint(this._latlng, t.zoom, t.center) : u.latLngToLayerPoint(this._latlng),
                d = this.getAllChildMarkers(),
                c = L.Path.SVG;for (h._animationStart(), this.setOpacity(1), i = d.length - 1; i >= 0; i--) {
              e = d[i], e._preSpiderfyLatlng && (e.setLatLng(e._preSpiderfyLatlng), delete e._preSpiderfyLatlng, o = !0, e._setPos && (e._setPos(l), o = !1), e.clusterHide && (e.clusterHide(), o = !1), o && _.removeLayer(e), c && (n = e._spiderLeg, s = n._path, r = s.getTotalLength() + .1, s.style.strokeDashoffset = r, n.setStyle({ opacity: 0 })));
            }setTimeout(function () {
              var t = 0;for (i = d.length - 1; i >= 0; i--) {
                e = d[i], e._spiderLeg && t++;
              }for (i = d.length - 1; i >= 0; i--) {
                e = d[i], e._spiderLeg && (e.clusterShow && e.clusterShow(), e.setZIndexOffset && e.setZIndexOffset(0), t > 1 && _.removeLayer(e), u.removeLayer(e._spiderLeg), delete e._spiderLeg);
          ...
          } }), L.MarkerClusterGroup.include({ refreshClusters: function refreshClusters(t) {
          ...
          }, _flagParentsIconsNeedUpdate: function _flagParentsIconsNeedUpdate(t) {
            var e, i;for (e in t) {
          ...
          }, _refreshSingleMarkerModeMarkers: function _refreshSingleMarkerModeMarkers(t) {
            var e, i;for (e in t) {
              i = t[e], this.hasLayer(i) && i.setIcon(this._overrideMarkerIcon(i));
            }
          } }), L.Marker.include({ refreshIconOptions: function refreshIconOptions(t, e) {
            var i = this.options.icon;return L.setOptions(i, t), this.setIcon(i), e && this.__parent && this.__parent._group.refreshClusters(this), this;
          } });
      }(window, document);
    }
  };
